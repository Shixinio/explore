<div class="tableDiv">
    <table class="mdl-data-table mdl-js-data-table aScrollTable goodSide">
        <thead>
            <tr>
                <th class="mdl-data-table__cell--non-numeric tbHeader">
                    <div class="tbaHeaderDiv floatLeft"><i class="material-icons">shopping_basket</i> <span>{{ count(@goods['goods']) }} Products</span></div>
                </th>
            </tr>
            <tr>
                <th class="mdl-data-table__cell--non-numeric">
                    <i class="material-icons">search</i>
                    <div class="mdl-textfield mdl-js-textfield aSearchDiv">

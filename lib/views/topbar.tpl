...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    <header class="mdl-layout__header mdl-shadow--4dp">
        <div class="mdl-layout__header-row">
            <!-- Title -->
            <span class="mdl-layout-title"><a href="/"><img src="/ui/images/logo.png" /></span>
            ...
            <span class="mdl-layout--large-screen-only headerDetails" id="marketSpan">
                <span class="mdl-layout--large-screen-only" id="blockBox">Block: <span id="inBlock"></span></span><span class="mdl-layout--large-screen-only" id="clockbox"></span>
            </span>
        </div>
    </header>
